...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter){
        ...
        try{
            ...
            while(rs.next()){
                ...
                tfaddress.setText(rs.getString("adddress"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == update){
            ...
            try{
                Conn c = new Conn();
                c.s.executeUpdate("update customer set adddress = '"+address+"',city = '"+city+"',state = '"+state+"',email = '"+email+"',phone = '"+phone+"' where meter_no = '"+meter+"'");
                
                JOptionPane.showMessageDialog(null, "User Information Updated Successfuly");
                setVisible(false);
            }catch(Exception e){
                e.printStackTrace();
            }
